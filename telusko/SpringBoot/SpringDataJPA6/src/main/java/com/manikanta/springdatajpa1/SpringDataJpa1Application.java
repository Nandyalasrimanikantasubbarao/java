...
import com.manikanta.view.ResultView1;
...
public class SpringDataJpa1Application {
    ...
    public static void main(String[] args) {
       ...
       service.fetchByCostLessThan(4900.56, ResultView1.class).forEach(v-> System.out.println(v.getVaccineName()+" "+v.getVaccineCompany()+" "+v.getCost()));
